            ...
            loadLink = function () {
                $.ajax({
                    ...
                    beforeSend: function(xhr) {
                        xhr.setRequestHeader('X-Notifications-Ajax', 1);
                    }
                })
                    .done(function (data, status, xhr) {
                        if(xhr.getResponseHeader('X-Notifications-AuthoriseAt')) {
                            window.location = xhr.getResponseHeader('X-Notifications-AuthoriseAt');
                            return;
                        }
